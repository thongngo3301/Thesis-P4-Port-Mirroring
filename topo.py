...
class SingleSwitchTopo(Topo):
    ...
    def __init__(self, sw_path, json_path, thrift_port, pcap_dump, **opts):
        ...
        switch1 = self.addSwitch('s1', sw_path=sw_path, json_path=json_path,
                                 thrift_port=thrift_port, cls=P4Switch, pcap_dump=pcap_dump)
...
def main():
    ...
    topo = SingleSwitchTopo(args.behavioral_exe, args.json,
                            args.thrift_port, args.pcap_dump)
